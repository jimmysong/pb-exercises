...
class NodeConnection:
    ...
    async def receive(self):
        ...
        while True:
            ...
            if magic != self.magic:
                raise RuntimeError('Network Magic not at beginning of stream {} vs {}'.format(magic.hex(), self.magic.hex()))
    ...
    async def process_queue(self):
        ...
        while True:
            ...
            if envelope.command.startswith(b'version'):
                ...
                self.last_block = bytes.fromhex('000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f')[::-1]
                end_block = b'\x00' * 32
...
#        '52.14.143.44',
    ...
    node = NodeConnection(host=node_list[0], port=8333)
