...
class Tx:
    ...
    def verify_input(self, input_index):
        ...
        point = S256Point.from_sec(inp.sec())
        # get the input signature
        der, sighash = inp.signature()
...
class TxIn:
    ...
    def outpoint(self, testnet=False):
        ...
        return tx_json['outputs'][self.prev_index]
    ...
    def serialize(self):
        ...
        # script_sig
        result += bytes([len(self.script_sig)]) + self.script_sig
        # sequence
...
class TxOut:
    ...
    def serialize(self):
        ...
        # pubkey
        result += bytes([len(self.script_pubkey)]) + self.script_pubkey
        return result
