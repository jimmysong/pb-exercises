...
class Script:
    ...
    def type(self):
        ...
        if self.elements[0:2] == [0x76, 0xa9] \
           and len(self.elements[2]) == 0x14 \
           and self.elements[3:] == [0x88, 0xac]:
            # p2pkh:
           ...
           and self.elements[-1] == 0x87:
            ...
            # <signature> <pubkey>
            return 'p2pkh sig'
        elif len(self.elements[1]) in (0x47, 0x48, 0x49) \
    ...
    def sec_pubkey(self, index=0):
        ...
        if sig_type == 'p2pkh sig':
            ...
            # HACK: assumes p2sh is a multisig
            redeem_script = Script.from_binary(self.elements[-1])
...
class ScriptTest(TestCase):
    ...
    def test_p2pkh(self):
        ...
        script_pubkey = Script.from_binary(script_pubkey_raw)
        ...
        script_sig = Script.from_binary(script_sig_raw)
