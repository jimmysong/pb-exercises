    ...
    def __repr__(self):
        ...
        for element in self.elements:
            if type(element) == int:
                ...
                result += '{} '.format(hexlify(element).decode('ascii'))
        return result
...
class ScriptTest(TestCase):
    ...
    def test_p2pkh(self):
        ...
        self.assertEqual(script_sig.signature(), unhexlify('3045022100ed81ff192e75a3fd2304004dcadb746fa5e24c5031ccfcf21320b0277457c98f02207a986d955c6e0cb35d446a89d3f56100f4d7f67801c31967743a9c8e10615bed01'))
    ...
    def test_p2sh(self):
        ...
        self.assertEqual(script_sig.serialize(), script_sig_raw)
        self.assertEqual(script_sig.signature(index=0), unhexlify('3045022100dc92655fe37036f47756db8102e0d7d5e28b3beb83a8fef4f5dc0559bddfb94e02205a36d4e4e6c7fcd16658c50783e00c341609977aed3ad00937bf4ee942a8993701'))
        self.assertEqual(script_sig.signature(index=1), unhexlify('3045022100da6bee3c93766232079a01639d07fa869598749729ae323eab8eef53577d611b02207bef15429dcadce2121ea07f233115c6f09034c0be68db99980b9a6c5e75402201'))
